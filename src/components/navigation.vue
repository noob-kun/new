  ...
  <div>
    ...
    >
      ...
      >
        ...
        >
          ...
          <ul class="navbar-nav flex flex-col pl-0 list-style-none mr-auto">
            <li class="nav-item p-2">
              <router-link
                class="nav-link text-gray-500 rounded hover:text-gray-100 focus:text-white-700 hover:bg-black p-3"
                to="/Login"
                >Login</router-link
              >
            </li>
        ...
        <!-- Right elements -->
        <div class="flex items-center relative mx-5">
          <!-- Icon -->
